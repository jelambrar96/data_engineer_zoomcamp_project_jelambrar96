...
module "google_cloud_composer_instance" {
  ...
  dataproc_cluster_name =  "" # dataproc_cluster_name = module.google_dataproc_instance.dataproc_cluster_name
  dataproc_num_masters = 0 # dataproc_num_masters = module.google_dataproc_instance.dataproc_num_masters_instances
  dataproc_num_workers = 0 # dataproc_num_workers = module.google_dataproc_instance.dataproc_num_workers_instances
  dataproc_master_machine_type = "" # dataproc_master_machine_type = module.google_dataproc_instance.dataproc_master_machine_type
  dataproc_worker_machine_type = "" # dataproc_worker_machine_type = module.google_dataproc_instance.dataproc_worker_machine_type
  dataproc_master_disk_type =  "" # dataproc_master_disk_type = module.google_dataproc_instance.dataproc_master_disk_type
  dataproc_worker_disk_type =  "" # dataproc_worker_disk_type = module.google_dataproc_instance.dataproc_worker_disk_type
